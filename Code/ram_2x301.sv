...
module ram_2x301(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input          R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [300:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[300:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
