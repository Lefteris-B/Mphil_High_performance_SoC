...
module SinkD(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][7:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :57:53, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][10:8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :78:54, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue2_TLBundleD_a32d64s5k3z3c d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
