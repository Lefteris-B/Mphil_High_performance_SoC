...
module TLBuffer_a32d256s6k5z3c(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  Queue1_TLBundleA_a32d256s6k5z3c nodeOut_a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue1_TLBundleD_a32d256s6k5z3c nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
