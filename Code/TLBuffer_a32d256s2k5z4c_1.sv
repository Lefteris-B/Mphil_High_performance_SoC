...
module TLBuffer_a32d256s2k5z4c_1(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  output [31:0]  auto_in_b_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [31:0] _nodeIn_b_q_io_deq_bits_mask;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [4:0]  _nodeIn_d_q_io_deq_bits_sink;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleA_a32d256s2k5z4c nodeOut_a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleD_a32d256s2k5z4c nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleB_a32d256s2k5z4c nodeIn_b_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleC_a32d256s2k5z4c nodeOut_c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleE_a32d256s2k5z4c nodeOut_e_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock            (clock),
    .reset            (reset),
