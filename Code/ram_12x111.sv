...
module ram_12x111(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [3:0]   R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [110:0] Memory[0:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [3:0] i = 4'h0; i < 4'hC; i += 4'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[110:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
