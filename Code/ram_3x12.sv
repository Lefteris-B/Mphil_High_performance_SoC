...
module ram_3x12(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [1:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [11:0] R0_data,
  ...
  reg [11:0] Memory[0:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h3; i += 2'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[11:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
