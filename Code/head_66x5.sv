...
module head_66x5(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
  input  [6:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [4:0] R0_data,
  ...
  reg [4:0] Memory[0:65];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
