...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  wire         r_beats1 = _c_q_io_deq_bits_opcode[0] & ~(_r_beats1_decode_T[5]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleC_a32d256s6k5z3c c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
